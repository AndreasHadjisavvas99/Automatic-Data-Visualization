...
for name, file_path in datasets.items():
    ...
    param_grid = {
        ...
        'max_iter': [1000,1500, 2000]  # Regularization terms
    }

    # Initialize and train Logistic Regression classifier
    lr_classifier = LogisticRegression(max_iter=10000, random_state=5)
    ...
    val_predictions = best_lr_model.predict(X_val)
    ...
    results_filename = f'lr_metrics/{name}_grid_search_results.csv'
