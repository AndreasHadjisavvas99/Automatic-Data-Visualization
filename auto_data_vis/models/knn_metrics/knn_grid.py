...
for name, file_path in datasets.items():
    ...
    # Preprocess data
    X = preprocess_data(X, apply_percentile_cutoff=True, apply_scaling=False, impute_missing=True, apply_one_hot_encoding=True)
    ...
    param_grid = {
        'n_neighbors': [2,3,4,5,6,7,8,9],  # Number of neighbors to use
    ...
    results_filename = f'knn_metrics/{name}_grid_search_results.csv'
