...
#features grouped into categories uniqueness/pairwise/categorical/quantitative/sequence
...
# Example 3: Quantitative Data
values_c = ['apple', 'banana', 'banana', 'cherry']
sortedness_c, is_sorted_c = sequence_features(values_c, 'c')
print(f"Categorical data - Sortedness: {sortedness_c}, Is sorted: {is_sorted_c}")
